...
export function StudentLayout() {
  ...
  const links = [
    { to: '/student/cvs', label: t('student.myCvs') },
    { to: '/student/offers', label: t('student.browseOffers') },
    { to: '/student/applications', label: t('student.myApplications') },
    { to: '/student/profile', label: t('student.profile') },
  ];
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--color-surface)' }}>
      <nav aria-label="القائمة الرئيسية" style={{
        ...
        <div style={{
          ...
          <button
            onClick={() => { logout(); navigate('/auth/student/login'); }}
